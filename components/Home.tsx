      ...
      <motion.div style={{ x: xSpring }} className="flex w-[200vw]">
        <div className="flex all-content">
          ...
          <div className="w-full h-full relative shadow-glow overflow-y-clip">
            ...
            >
              {/* One glow for the whole information stack instead of one per panel */}
              <div className="flex flex-col shadow-glow-desktop">
              ...
              {/* One glow for the whole project stack instead of one per project */}
              <div className="w-screen md:w-[calc(100vw-200px)] lg:w-[calc(100vw-286px)] flex flex-col shadow-glow-desktop">
